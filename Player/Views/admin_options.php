...
<body style="width:98%" onLoad="startTime()">
    ...
    <table style="width:102.1%;height:95%;margin-left:-0.8%;margin-top:-10px">
        <tr style="width:100%;height:60px">
            <td><a href="../Player/index.php?page=administration" title="Retour à l'accueil">
...
<tr style="height:10%">
    ...
    <td class="options_zone" colspan ="2"rowspan="2"style="text-align:center;width:12%;height:auto">
        ...
        <ul ss-container style="padding:5px;margin-top:5px">
            ...
            <li><div class="button_choice"><input class = "button1" type="submit" name="add_style" value="Ajouter un Genre"></div></li>
            <li><div class="button_choice"><input class = "button2" type="submit" name="add_lyrics" value="Ajouter des Paroles"></div></li>
            <li><div class="button_choice"><input class = "button1" type="submit" name="add_album" value="Nouvel Album"></div></li>
            <li><div class="button_choice"><input class = "button2" type="submit" name="add_artist" value="Nouvel Artiste"></div></li>
            <li><div class="button_choice"><input class = "button1" type="submit" name="remove_album" value="Supprimer un Album"></div></li>
            <li><div class="button_choice"><input class = "button2" type="submit" name="remove_artist" value="Supprimer un Artiste"></div></li>
                        <li><div class="button_choice"><input class = "button1" type="submit" name="suppress_music" value="Supprimer une musique"></div></li>
                    </ul>
                </form>
            </td>
        </tr>
