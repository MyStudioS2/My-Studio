...
<body style="width:98%">
    ...
    <td class="options_zone" rowspan="2"style="text-align:center;width:12%;height:auto">
        <form action="../index.php?page=administration" name="option" method="POST">
        <ul ss-container style="padding:5px">
            ...
            <li><div class="button_choice"><input class = "button" type="submit" name="add_lyrics" method="POST" value="Ajouter des Paroles"></div></li>
