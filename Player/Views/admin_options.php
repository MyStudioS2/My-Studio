...
<body style="width:98%" onLoad="startTime()">
    ...
    <table style="width:102.1%;height:95%;margin-left:-0.8%;margin-top:-10px">
        <tr style="width:100%;height:60px">
            <td><a href="../Player/index.php?page=administration" title="Retour à l'accueil"style="margin-top:-2px">
            ...
            <br>Il est <span id="txt" style="color:#a2ab58"></span>. Amusez-vous bien !</span> </div></td>
...
<tr style="height:10%">
    <td class="body_zone"style="text-align:center;float:middle"><div class="corpse" id="corpse">Lorem Ipsum Dolor Sit Amet</div></td>
    <td class="options_zone" colspan ="2"rowspan="2"style="text-align:center;width:11%;height:auto">
        ...
        <form action="../Player/index.php?page=administration" name="options" method="POST">
         <ul ss-container style="padding:0px;margin-top:25px;background-color:#3C3B3F;height:460px;width:170px;border-radius:6px;margin-right:15px" class="ulol">
         <div class="options_choice"style="margin-top:5px">
         <li><div class="option_choice"><br>Vos options :</li>
            <li><div class="option_choice"><input class = "button1" type="submit" name="add_style" value="Ajouter un Genre"></div></li>
            <li><div class="option_choice"><input class = "button2" type="submit" name="add_lyrics" value="Ajouter des Paroles"></div></li>
            <li><div class="option_choice"><input class = "button1" type="submit" name="add_album" value="Nouvel Album"></div></li>
            <li><div class="option_choice"><input class = "button2" type="submit" name="add_artist" value="Nouvel Artiste"></div></li>
            <li><div class="option_choice"><input class = "button1" type="submit" name="remove_album" value="Supprimer un Album"></div></li>
            <li><div class="option_choice"><input class = "button2" type="submit" name="remove_artist" value="Supprimer un Artiste"></div></li>
                        <li><input class = "button1" type="submit" name="suppress_music" value="Supprimer une musique"></div></li>
                    </div>
                    </ul>
                </form>
            </td>
