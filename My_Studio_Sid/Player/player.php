...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div style="position:relative;width:307px;height:209px;overflow: scroll;" class="playlist">
    ...
    <li id="li0" class="dd" style="font-size:16px;width:350px;height:25px">
                    ...
                    <audio src='./musics/Summer_Knights.mp3' preload ="metadata" id="audio0" class="playlist"></audio>
                </li>
                <div class="dropdown-divider"><p>100</p></div>  
                <li id="li1" class="dd" style="font-size:16px;width:350px;height:25px;margin-left:0px;">
                    ...
                    <audio src='./musics/Waves.mp3' preload ="metadata" class="playlist" id="audio1"></audio>
                </li>
                ...
                <div class="current_playlist" id="c3" style="font-size:16px;width:350px;height:25px;display:inline;white-space:nowrap">
            ...
            <button class ="btn" id="lol" onclick="close_window()"> dsquidgiuqsgduiqg </button>
</body>

<script>
if(localStorage.openpages){
        alert('<center>Le player est déjà actif dans un autre onglet. \nAfin de comptabiliser correctement les vues et rémunèrer nos artistes, le player ne sera actif sur cet onglet</center>');
...
$(document).ready(function(){
   ...
   function player(){
       ...
       var playlist = document.getElementsByClassName('playlist');
        ...
        var t_content = 'Durée totale : '+ duration +' mins '+ seconds +'s';
  ...
  function shuffle(){
        var img = document.getElementById('shuffle').style.backgroundImage;
            if(img === 'url("./img/sh_off.png")'){
                ...
                var where = Number(playlist.length-1);
                console.log(where);
                playlist = save;
               ...
               document.getElementById(div.id).appendChild(audio);**/
                ...
                var playlist_html_content = document.getElementsByClassName('playlist').children;
                console.log(playlist_html_content);
                /**z = $("#play_or_pause3").detach();
                y = $("#c3").detach();
                x = $("#li3").detach();
                console.log(z);
                console.log(x);
