    ...
    <?php
        ...
        if(isset($_POST['name'])){
            ...
            if(empty($_POST['name']) || empty($_POST['first_name']) || empty($_POST['adress']) || empty($_POST['postal']) || empty($_POST['town'])||empty($_POST['nick'])||empty($_POST['pwd'])){
                ...
                echo('<center>Bienvenue sur magic-ali-mentation.com, veuillez vous inscire afin de profiter de nos services.</center><br/>');
                ...
                echo("<center><bold>Les champs suivants n'ont pas été remplis : $name $first $adress $postal $town $pwd $nic!<br/>
                Les champs marqués par un * sont relatifs au suivi de commande. <br/>Les champs marqués par un ** concernent votre compte sur le site.<bold></center>");
                ...
                $check=reg_check($_SESSION);
                         /** Mauvais pseudo/pwd, réaffiche page avec formulaire prérempli */
                if(reg_check($_POST['nick']) == false){
                    echo('<center>Bienvenue sur magic-ali-mentation.com, veuillez vous inscrire afin de profiter de nos services.</center><br/>');
                    echo('<center><form action="" method="POST">
                        <center><h3>Inscription</h3></center></br>
                        ...
                        <br/>
                        <center>Les champs marqués par un * sont relatifs au suivi de commande.<br/> Les champs marqués par un ** concernent votre compte sur le site.</center>
                        ");
                ...
                $tableau = array(array($_SESSION['name'],$_SESSION['first_name'],$_SESSION['addr'],$_SESSION['nick'],$_SESSION['pwd']));
                ...
                fclose($tmp);
                echo('<center>Bienvenue sur magic-ali-mentation.com,');echo $_POST['nick'];echo('!.</center><br/>');
            ...
            echo('<center><form action="" method="POST">
                ...
                <br/>
                <center>Les champs marqués par un * sont relatifs au suivi de commande. <br/></center><center>Les champs marqués par un ** concernent votre compte sur le site.</center>');
