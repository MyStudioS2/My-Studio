<?php
require('../Controlers/registration.php');
...
<img src='../Vues/LOGO.jpg'width='200' height='150'></center>";

} else {

echo"<center><h3>Mystudio</h3></center><br><center>S'inscrire sur Mystudio</center>
        ...
        <a href='page_connexion.php'>Retour à la page de connexion</a>
        <br></center>";
